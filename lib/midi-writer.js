...
function writeMidi(data, opts) {
  ...
  var w = new Writer(opts)
  writeHeader(w, header, len, opts)
...
function writeHeader(w, header, numTracks, opts) {
...
Writer.prototype.writeId = function(str) {
